...
```bash
export DOMAIN=readyapi-project.example.com
```
...
## Deploy the ReadyAPI Project

Now that you have Traefik in place you can deploy your ReadyAPI project with Docker Compose.
...
Replace `readyapi-project.example.com` with your domain.

### Main Traefik Dashboard

Traefik UI: `https://traefik.readyapi-project.example.com`
